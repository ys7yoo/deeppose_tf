...
# put data in /tmp
LSP_DATASET_ROOT = os.path.expanduser('/tmp/data/lsp')
LSP_EXT_DATASET_ROOT = os.path.expanduser('/tmp/data/lsp_ext')
MPII_DATASET_ROOT = os.path.expanduser('/tmp/data/mpii')
