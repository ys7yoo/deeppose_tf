...
--test_step 1000 \
--log_step 10 \
--train_csv_fn ${DATA_ROOT}/MET3/activity1.csv \
--val_csv_fn ${DATA_ROOT}/MET3/activity1.csv \
--test_csv_fn ${DATA_ROOT}/MET3/activity1.csv \
...
--fix_conv_iter 10000 \
--optimizer adam \
--o_dir ${PROJ_ROOT}/out/DBG_${DATE_TIME}_met_n10_ub_alexnet_imagenet_${HOSTNAME}_gpu${1} \
--gcn \
--fliplr \
--workers 8 \
--net_type Alexnet \
